...
public class ChocoExplainErrorFMDIAGParallel4 extends ChocoQuestion implements ValidConfigurationErrorsQuestion {
	...
	public ChocoExplainErrorFMDIAGParallel4(int t){
		this.m = 1;
