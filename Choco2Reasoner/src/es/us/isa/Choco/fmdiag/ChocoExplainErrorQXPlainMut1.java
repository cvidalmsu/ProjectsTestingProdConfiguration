...
public class ChocoExplainErrorQXPlainMut1 extends ChocoQuestion implements ValidConfigurationErrorsQuestion {
...
//		System.out.println(B + " - " + C);
	...
	///Change logic operatorsChocoExplainErrorFMDIAG.java

	public List<String> qxplain(List<String> C, List<String> B) throws InterruptedException {
...
//		Thread.sleep(5000);
	...
	public List<String> qx(List<String> C, List<String> B, List<String> Bd) {		
		...
		List<String> A1 = qx(C1, plus(B,C2), C2);
		List<String> A2 = qx(C2, plus(B, A1), A1);
