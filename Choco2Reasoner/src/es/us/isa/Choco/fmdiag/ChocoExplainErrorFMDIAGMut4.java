...
public class ChocoExplainErrorFMDIAGMut4 extends ChocoQuestion implements ValidConfigurationErrorsQuestion {
...
//		System.out.println(AC + " - " + S);
	...
	///Change logic operators and logic connectors and math operators (+ by -, * by / and viceversa)
	///isConsistent
	...
	public List<String> diag(List<String> D, List<String> S, List<String> AC) {
		...
		List<String> A1 = diag(S2, S1, plus(AC, S2));
		List<String> A2 = diag(A1, S2, plus(AC, A1));
