...
public class ChocoHomogeneityQuestion extends ChocoQuestion implements
		HomogeneityQuestion {

	private DefHomogeneityQuestion vq;
	
	public ChocoHomogeneityQuestion(){
		vq = new DefHomogeneityQuestion();
	}
	...
	class DefHomogeneityQuestion extends DefaultHomogeneityQuestion{
		...
		public UniqueFeaturesQuestion uniqueFeaturesQuestionFactory() {
			return new ChocoUniqueFeaturesQuestion();
		}
