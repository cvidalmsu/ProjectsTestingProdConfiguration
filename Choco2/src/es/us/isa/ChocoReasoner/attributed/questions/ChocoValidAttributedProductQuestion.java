...
public class ChocoValidAttributedProductQuestion extends ChocoQuestion
		implements ValidAttributedProductQuestion {

	protected ChocoDefValidAttributeProductQuestion vapq;
	
	public ChocoValidAttributedProductQuestion() {
		super();
		vapq = new ChocoDefValidAttributeProductQuestion();
	}
	...
	public PerformanceResult answer(Reasoner r) throws FAMAException, InterruptedException{
		...
		vapq.setFeatures(choco.getAllFeatures());
		return vapq.answer(choco);
	}
